...
OVERLAP_HARD_PEAKS = [
    {"mu": 150, "amplitude": 800,  "sigma": 120, "alpha": 30.0},
...
NOISE = 0.1
DURATION = 1200
EXPECTED = expected_peak_properties(OVERLAP_HARD_PEAKS, n_sigma=3.0)


@pytest.fixture(scope="module")
def detected_peaks():
    time, signal = make_raw_signal(OVERLAP_HARD_PEAKS, noise_scale=NOISE, duration=DURATION)
